<?php
/**
 * TOP API: taobao.alitrip.cruise.item.add request
 * 
 * @author auto create
 * @since 1.0, 2016.06.27
 */
class AlitripCruiseItemAddRequest
{
	/** 
	...
	{
		return "taobao.alitrip.cruise.item.add";
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->cruiseIti,"cruiseIti");
		RequestCheckUtil::checkNotNull($this->feeExclude,"feeExclude");
		RequestCheckUtil::checkNotNull($this->feeInclude,"feeInclude");
		RequestCheckUtil::checkNotNull($this->landingCity,"landingCity");
		...
		RequestCheckUtil::checkNotNull($this->shipCompany,"shipCompany");
		RequestCheckUtil::checkNotNull($this->shipName,"shipName");
		RequestCheckUtil::checkMaxLength($this->sub1Title,35,"sub1Title");
		RequestCheckUtil::checkMaxLength($this->sub2Title,35,"sub2Title");
		RequestCheckUtil::checkMaxLength($this->sub3Title,35,"sub3Title");
		RequestCheckUtil::checkMaxLength($this->sub4Title,35,"sub4Title");
