<section class="container-fluid">
    ...
    <div class="box">
        <header class="" id="operation_bar">
            ...
            <ul class="tag with-x" id="filter_label"></ul>

            <div class="pin-wrapper" style="height: 50px;">
                <div class="operate" style="width: 1841px;">
                <span class="dropdown" id="filter_warp">
                    <button class="btn btn-default btn-sm" data-toggle="dropdown" id="filter"><i
                            class="iconfont mr5"></i>批量筛选
                    </button><div class="dropdown-menu dropdown-table">
                        <div>
                            <ul>


                                <li data-id="match_scope">
                                    <span class="title tr">匹配方式</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="匹配方式" data-status="广泛匹配"
                                               value="SM">广泛匹配 <span class="sub">(53个)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="匹配方式" data-status="精准匹配"
                                               value="SL">精准匹配 <span class="sub">(1个)</span>
                                    </label>
                                ...
                                <li data-id="max_price">
                                    <span class="title tr">PC出价</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="PC出价" data-status="一般" value="MM">一般 <span
                                            class="sub">(42个，范围0.48元-0.80元)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="PC出价" data-status="较低" value="ML">较低 <span
                                            class="sub">(12个，范围0.32元-0.47元)</span>
                                    </label>
                                ...
                                <li data-id="max_mobile_price">
                                    <span class="title tr">移动出价</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="移动出价" data-status="较高" value="YH">较高 <span
                                            class="sub">(45个，范围0.81元-1.52元)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="移动出价" data-status="一般" value="YM">一般 <span
                                            class="sub">(9个，范围0.48元-0.80元)</span>
                                    </label>
                                ...
                                <li data-id="qscore">
                                    <span class="title tr">PC质量分</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="PC质量分" data-status="高" value="QH">高 <span
                                            class="sub">(22个，范围8-9)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="PC质量分" data-status="中" value="QM">中 <span
                                            class="sub">(31个，范围5-7)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="PC质量分" data-status="低" value="QL">低 <span
                                            class="sub">(1个，范围3-4)</span>
                                    </label>
                                ...
                                <li data-id="wireless_qscore">
                                    <span class="title tr">移动质量分</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="移动质量分" data-status="高" value="WH">高 <span
                                            class="sub">(47个，范围8-10)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="移动质量分" data-status="中" value="WM">中 <span
                                            class="sub">(7个，范围5-7)</span>
                                    </label>
                                ...
                                <li data-id="click">
                                    <span class="title tr">点击量</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="点击量" data-status="高" value="KH">高 <span
                                            class="sub">(2个，范围78-755)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="点击量" data-status="中" value="KM">中 <span
                                            class="sub">(5个，范围36-77)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="点击量" data-status="低" value="KL">低 <span
                                            class="sub">(38个，范围1-35)</span>
                                    </label>
                                ...
                                <li data-id="ctr">
                                    <span class="title tr">点击率</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="点击率" data-status="高" value="TH">高 <span
                                            class="sub">(9个，范围6.54%-11.27%)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="点击率" data-status="一般" value="TM">一般 <span
                                            class="sub">(19个，范围3.82%-6.53%)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="点击率" data-status="低" value="TL">低 <span
                                            class="sub">(17个，范围0.58%-3.81%)</span>
                                    </label>
                                ...
                                <li data-id="cpc">
                                    <span class="title tr">平均花费</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="平均花费" data-status="偏高" value="CH">偏高 <span
                                            class="sub">(9个，范围0.88-1.10)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="平均花费" data-status="适中" value="CM">适中 <span
                                            class="sub">(28个，范围0.48-0.87)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="平均花费" data-status="较低" value="CL">较低 <span
                                            class="sub">(8个，范围0.19-0.47)</span>
                                    </label>
                                ...
                                <li data-id="roi">
                                    <span class="title tr">投资回报</span>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="投资回报" data-status="盈利" value="RH">盈利 <span
                                            class="sub">(6个，范围1.50-16.07)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="投资回报" data-status="持平" value="RM">持平 <span
                                            class="sub">(2个，范围1.00-1.49)</span>
                                    </label>

                                    <label class="checkbox-inline">
                                        <input type="checkbox" data-title="投资回报" data-status="亏本" value="RL">亏本 <span
                                            class="sub">(37个，范围0.00-0.99)</span>
                                    </label>
                    ...
                    <div class="dropdown-menu hold-on-click dropdown-table">
                        ...
                        <div class="radio mt5">
                            <label>
                                ...
                                根据调价金额：降价<input type="text"> 元
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="price" value="parcentDown">
                                根据调价比例：降价<input type="text"> %
                            </label>
                        </div>
                        ...
                        <div class="radio mt5">
                            <label>
                                ...
                                根据调价金额：加价<input type="text"> 元
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="price" value="parcentUp">
                                根据调价比例：加价<input type="text"> %
                            </label>
                        </div>
                        <div class="radio">
                            最高限价：<input type="text" id="price_limit"> <i class="iconfont" data-toggle="tooltip"
                                                                         data-placement="right" data-trigger="hover"
                                                                         title=""
                                                                         data-original-title="当修改的出价大于最高限价时，会使用最高限价作为出价"></i>
                        </div>
                        <div class="lh30">
                            <button type="button" class="btn btn-primary btn-sm">确定</button>
                            <button type="button" class="btn btn-default btn-sm">取消</button>
                ...
                <span class="dropdown" id="mobile_price_warp">
                    ...
                    <div class="dropdown-menu hold-on-click dropdown-table">
                        ...
                        <div class="radio">
                            最高限价：<input type="text" id="price_limit_mobile"> <i class="iconfont" data-toggle="tooltip"
                    ...
                    <button class="btn btn-default btn-sm" id="bluk_del">删 除</button>
                <span class="dropdown" id="match_warp">
                    ...
                    <ul class="ul_line select_info">
                        ...
                        <li class="pr10 select_status tdl poi" mode="1">PC降价(<span class="b" id="down_num">0</span>)
                        </li>
                        <li class="pr10 select_status tdl poi" mode="5">移动加价(<span class="b" id="up_mobile_num">0</span>)
                        </li>
                        <li class="pr10 select_status tdl poi" mode="6">移动降价(<span class="b"
                                                                                   id="down_mobile_num">0</span>)
                        </li>
...
">
            ...
            <span class="input-group-btn search_btn">
                ...
                <tr id="299044364525" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    data-locked="0" data-weird-desc="6000000000" data-weird-asc="1000000000" class="even">
                ...
                <tr id="299044364579" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    data-locked="0" data-weird-desc="6000000000" data-weird-asc="1000000000" class="odd">
                    <td class="check_column ">
                        <input type="checkbox">
                    </td>
                    <td class="hide  sorting_1">
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.80">
                        <i class="iconfont recovery"></i>
                    </td>
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_mobile_price" value="1.52">
                        <i class="iconfont recovery_mobile"></i>
                    </td>
                    <td class="sort_custom ">
                        <span class="hide">0</span>
                ...
                <tr id="300313255535" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.58">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="299044364524" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    data-locked="0" data-weird-desc="4000000000" data-weird-asc="3000000000" class="even">
                    <td class="check_column ">
                        <input type="checkbox">
                    </td>
                    <td class="hide  sorting_1">
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.48">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="299044364578" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    data-locked="0" data-weird-desc="5000000000" data-weird-asc="2000000000" class="even">
                    <td class="check_column ">
                        <input type="checkbox">
                    </td>
                    <td class="hide  sorting_1">
                ...
                <tr id="299044364582" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.69">
                        <i class="iconfont recovery"></i>
                    </td>
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_mobile_price" value="1.31">
                        <i class="iconfont recovery_mobile"></i>
                    </td>
                    <td class="sort_custom ">
                        <span class="hide">0</span>
                ...
                <tr id="299044364593" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    data-match="4" data-mnt="0" data-new_price="0.64" data-new_mobile_price="1.17" data-optm_type="2"
                    data-locked="0" data-weird-desc="5000000000" data-weird-asc="2000000000" class="odd">
                    <td class="check_column ">
                        <input type="checkbox">
                    </td>
                    <td class="hide  sorting_1">
                ...
                <tr id="299075082342" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_mobile_price" value="0.96">
                        <i class="iconfont recovery_mobile"></i>
                    </td>
                    <td class="sort_custom ">
                        <span class="hide">0</span>
                ...
                <tr id="300313255556" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_mobile_price" value="1.08">
                        <i class="iconfont recovery_mobile"></i>
                    </td>
                    <td class="sort_custom ">
                        <span class="hide">0</span>
                ...
                <tr id="300315818067" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.67">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="300315818069" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.56">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="300315818083" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.73">
                        <i class="iconfont recovery"></i>
                    </td>
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_mobile_price" value="1.38">
                        <i class="iconfont recovery_mobile"></i>
                    </td>
                    <td class="sort_custom ">
                        <span class="hide">0</span>
                ...
                <tr id="299044364554" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    data-weird-desc="3000000000" data-weird-asc="4000000000" class="odd">
                    <td class="check_column ">
                        <input type="checkbox">
                    </td>
                    <td class="hide  sorting_1">
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.41">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="299044364587" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.66">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="299075082292" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    data-weird-desc="3000000000" data-weird-asc="4000000000" class="even">
                    <td class="check_column ">
                        <input type="checkbox">
                    </td>
                    <td class="hide  sorting_1">
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.79">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="299075082344" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.37">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="299070329915" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.45">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="299070329913" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.34">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="299075082263" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.76">
                        <i class="iconfont recovery"></i>
                    </td>
                ...
                <tr id="300315818066" data-adgroup_id="715202952" data-campaign_id="35560990"
                    ...
                    <td class=" ">
                        <input type="text" maxlength="5" class="w40 new_price" value="0.33">
                        <i class="iconfont recovery"></i>
                    </td>
